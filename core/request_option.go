...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Version", "v0.0.127")
	return headers
}
...
// ServerPrefixOption implements the RequestOption interface.
type ServerPrefixOption struct {
	ServerPrefix string
}

func (s *ServerPrefixOption) applyRequestOptions(opts *RequestOptions) {
	opts.ServerPrefix = s.ServerPrefix
}
