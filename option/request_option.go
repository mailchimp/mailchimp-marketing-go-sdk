...
// WithServerPrefix sets the "serverPrefix" server URL variable, which is
// substituted into the base URL template(s) at construction time.
func WithServerPrefix(serverPrefix string) *core.ServerPrefixOption {
	return &core.ServerPrefixOption{
