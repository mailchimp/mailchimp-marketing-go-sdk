# Mailchimp Go Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fmailchimp%2Fmailchimp-marketing-go-sdk)

The Mailchimp Go library provides convenient access to the Mailchimp APIs from Go.
...
A full reference for this library is available [here](https://github.com/mailchimp/mailchimp-marketing-go-sdk/blob/HEAD/./reference.md).
...
ctx := context.TODO()
page, err := client.AccountExports.List(
    ctx,
    ...
)
if err != nil {
...
```go
response, err := client.AccountExports.Create(...)
if err != nil {
...
```go
response, err := client.AccountExports.WithRawResponse.Create(...)
if err != nil {
    return err
}
...
response, err := client.AccountExports.Create(ctx, ...)
```
...
response, err := client.AccountExports.Create(ctx, request, ...)
```
